...
// would create a compile-time type cycle.
ColumnLayout {
    id: root
    ...
    Loader {
        ...
        active: detailComponent.length > 0 && evaluatorLoader.item !== null
    ...
    Label {
        ...
        text: qsTr("No evaluation selected — pick an evaluate block from "
                   + "the palette to score the run.")
